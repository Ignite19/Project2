...
#
# CONTENT_TYPE:      The MIME type of associated with the option body of 
the HTTP request.
...
# HTTP_USER_AGENT:   Information about the browser/client that made 
requested.
...
echo "Here is some more info on Query String"

echo "<pre>QUERYSTRING:$QUERY_STRING</pre>


echo"' ${ --curl http://www.csun.edu}'"
